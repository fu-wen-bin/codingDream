  ...
  <div class="min-h-screen bg-gray-50 dark:bg-gray-900 transition-colors">
    ...
    <header class="bg-white dark:bg-gray-800 shadow-sm border-b border-gray-200 dark:border-gray-700">
      <div class="max-w-4xl mx-auto px-4 py-4 flex justify-between items-center">
        ...
        >
          <i v-if="isDark" class="lucide-sun w-5 h-5 text-yellow-500"/>
          <i v-else class="lucide-moon w-5 h-5 text-gray-600"/>
        </button>
      </div>
    </header>
    ...
    <main class="max-w-4xl mx-auto px-4 py-8">
      ...
      <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6">
        ...
        <div class="mb-6">
          ...
          >
            <i v-if="isAnalyzing" class="lucide-loader-2 w-4 h-4 animate-spin"/>
            <i v-else class="lucide-brain w-4 h-4"/>
        ...
        <div v-if="error" class="p-4 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg">
          <div class="flex items-center gap-2 text-red-800 dark:text-red-200">
            <i class="lucide-alert-circle w-5 h-5"/>
...
// 已通过UnoCSS的presetIcons处理图标，无需单独导入
